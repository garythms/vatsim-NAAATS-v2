...
class CCommonRenders // Commonly rendered items, here for ease of access
{
	public: 
		...
		static void RenderDropDown(CDC* dc, Graphics* g, CRadarScreen* screen, POINT topLeft, int width, int height, CDropDown* obj, bool drawList = true);
		...
		static void RenderAdjacentSectors(CDC* dc, Graphics* g, CRadarScreen* screen, void* fltPlnWindow);
};
