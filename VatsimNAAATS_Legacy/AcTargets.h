...

{
	...
	public:
		...
		// Render tags
		static POINT RenderTag(Graphics* g, CDC* dc, CRadarScreen* screen, CRadarTarget* target, pair<bool, POINT>* tagPosition, bool isWestbound, CSTCAStatus* status, string asel);
