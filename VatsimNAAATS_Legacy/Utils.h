...
class CUtils { // TODO: refactor into namespace
	public:
		...
		// Get the aircraft direction (true = Westbound, false = Eastbound)
		static bool GetAircraftDirection(int heading);

		// Get direction from origin and destination (true = Westbound, false = Eastbound)
		static bool GetDirectionFromADEP(string adep, string ades);
		...
		// Aircraft state
		bool Direction; // true=West, false=East
