...

{
	...
	public:
		...
		// Notification logic
		static void AddNatTrakNotification(const string& callsign);
		static vector<string> GetNatTrakNotifications();
		static void AcknowledgeNatTrakNotification(const string& callsign);
		static bool HasNewNatTrakNotification() { return hasNewNotification; }
		static void SetNewNatTrakNotification(bool val) { hasNewNotification = val; }
	...
	private:
		...
		// Notifications
		static vector<string> natTrakNotifications;
